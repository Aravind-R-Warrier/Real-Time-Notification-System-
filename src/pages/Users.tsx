...
export default function UsersPage() {
  ...
  const planDistribution = [
    {
      name: "Free",
      count: totals.planCounts.Free || 0,
      color: "from-gray-400 to-slate-500",
    },
    {
      name: "Pro",
      count: totals.planCounts.Pro || 0,
      color: "from-green-400 to-emerald-500",
    },
    {
      name: "Business",
      count: totals.planCounts.Business || 0,
      color: "from-blue-400 to-cyan-500",
    },
    {
      name: "Enterprise",
      count: totals.planCounts.Enterprise || 0,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-900/10 rounded-xl p-4">
              ...
              <p className="text-xs text-gray-500 mt-1">
                {Math.round((totals.active / totals.total) * 100) || 0}% active
              </p>
            </div>
            <div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-900/10 rounded-xl p-4">
              ...
              <p className="text-xs text-gray-500 mt-1">
                {Math.round((totals.inactive / totals.total) * 100) || 0}%
                inactive
              </p>
            </div>
                    ...
                    <div className="mt-2">
                      <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${(plan.count / totals.total) * 100 || 0}%`,
                          }}
                        />
                      </div>
                    </div>
            ...
            <form onSubmit={handleInviteSubmit} className="space-y-6">
              <div>
                ...
                <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                  Demo: This creates a local user entry. In production, this
                  would send an actual email invitation.
                </p>
              </div>
